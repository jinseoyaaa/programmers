...
def solution(str1, str2):
    ...
    if not set1 and not set2:
        return 65536
    intersection = sum([min(set1.count(s), set2.count(s)) for s in set(set1) & set(set2)])
    union = sum([max(set1.count(s), set2.count(s)) for s in set(set1) | set(set2)])
    answer = int((intersection / union) * 65536)
    return answer

str1 = "FRANCE"
str2 = "french"
solution(str1, str2)   # 16384